  ...
  <div class="home-container">
   <div class="home-main">
    ...
    <div class="home-main-image">
      <img src="images/hamza-nouasria-KXrvPthkmYQ-unsplash 1.jpg" alt="Photo of a man reading a book">
      <p>Hamza</p>
    </div>
   </div>
   <div class="home-last-books">
    ...
    <div class="home-last-books-list">
      <div class="home-last-book">
        ...
        <p class="last-book-title">Esther</p>
        <p class="last-book-author">Alabaster</p>
        <p class="last-book-seller">Vendu par: </p>
      </div>
      <div class="home-last-book">
        <img src="images/Rectangle 2-1.jpg" alt="">
        <p class="last-book-title">The Kinfolk Table</p>
        <p class="last-book-author">Nathan Williams</p>
        <p class="last-book-seller">Vendu par: </p>
      </div>
      <div class="home-last-book">
        <img src="images/Rectangle 2-2.jpg" alt="">
        <p class="last-book-title">Wabi Sabi</p>
        <p class="last-book-author">Beth Kempton</p>
        <p class="last-book-seller">Vendu par: </p>
      </div>
      <div class="home-last-book">
        <img src="images/Rectangle 2-3.jpg" alt="">
        <p class="last-book-title">Milk & honey</p>
        <p class="last-book-author">Rupi Kaur</p>
        <p class="last-book-seller">Vendu par: </p>
      </div>
    </div>
    <button>Voir tous les livre</button>
   </div>
   ...
   <div class="home-banner">
    <img src="images/Mask group-1.jpg" alt="Banner">
   </div>
